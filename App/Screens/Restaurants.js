            ...
            {context => (
                <View style={styles.container}>
                    ...
                    <View style={styles.BgImg}>
                        <ImageBackground source={{ uri: 'https://www.zopofy.com/blog/wp-content/uploads/2019/02/bread-breakfast-coffee-374052.jpg' }} style={{ width: '100%', height: '100%', justifyContent: 'center' }} />
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: 10 }}>
                            <FeatherIcon name={'phone-call'} color={'grey'} size={15} />
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ width: '90%', alignSelf: 'center', marginBottom: 10 }}>
